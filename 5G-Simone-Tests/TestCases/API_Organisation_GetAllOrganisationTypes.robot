...
*** Test Cases ***
Validate "Organisation/GetAllOrganisationTypes"
    [Tags]      API         Get         Organisation
    API_Keywords.Tenant Admin Login
    API_Keywords.Create Base Session
    API_Keywords.Request Header
    API_Keywords.Create Get Request Session For "Organisation_GetAllOrganisationTypes"
