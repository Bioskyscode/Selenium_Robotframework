...
googleMap = '//div[@class="mapContainer leaflet-container leaflet-touch leaflet-fade-anim leaflet-grab leaflet-touch-drag leaflet-touch-zoom"]'
...
Select_Station = '//*[@id="head-top"]'
Topic_tab = '//div[@id="tabs"]'
Minden_HBF = '//li[@aria-label="Minden HBF"]'
Bielefeld_HBF = '//li[@aria-label="Bielefeld Hbf"]'
Lemgo_BHF = '//li[@aria-label="Lemgo, Bahnhof"]'
Bösingfeld_HBF = '(//li[@aria-label="Am Bhf 1, Bösingfeld"])[1]'
